...
class Image {
  ...
  factory Image.fromJson(Map<String, dynamic> json) {
    return Image(imageUrl: json['image_url'], isCorrect: json['is_correct']);
  }
}
...
class ImageProcessor {
  final url = 'http://mindbridge.dipeshacharya.tech/api/alphabet-images';
...
final imageProcessorProvider = FutureProvider.family<ImageResponse, String>((
  ref,
  letter,
) async {
